      ...
      >
        ...
        >
          {children.map((child, i) => (
            <Fragment key={i}>
              {cloneElement(child as React.ReactElement<SlideProps>, { width })}
            </Fragment>
          ))}
          {children.map((child, i) => (
            <Fragment key={i}>
      ...
      {blurBorders && (
        <>
          <div
            ...
            className="absolute top-0 -right-[2px] z-10 w-[100px] md:w-[180px] h-full"
          />
          <div
            style={{
              background: `linear-gradient(90deg, ${blurBorderColor} 10%, rgba(255, 255, 255, 0) 80%)`,
            }}
            className="absolute top-0 -left-[2px] z-10 w-[100px] md:w-[180px] h-full"
          />
        </>
      )}
    </div>
